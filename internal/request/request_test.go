...
func TestRequestLineParse(t *testing.T) {
	...
	_, err = RequestFromReader(strings.NewReader("GET /black coffee HTTP/1.1\r\nHost: localhost:42069\r\nUser-Agent: curl/7.81.0\r\nAccept: */*\r\n\r\n"))
	require.Error(t, err)

	// Test: Non-caps method
	...
	_, err = RequestFromReader(strings.NewReader("GET /coffee SMTP/1.1\r\nHost: localhost:42069\r\nUser-Agent: curl/7.81.0\r\nAccept: */*\r\n\r\n"))
	require.Error(t, err)
}

func TestFullHeaderParse(t *testing.T) {
